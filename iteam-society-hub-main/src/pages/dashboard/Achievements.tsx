...
const Achievements = () => {
  ...
  const fetchAchievements = async () => {
    ...
    try {
      ...
      const eventsAttended = registrations?.filter((r) => r.attended).length || 0;
      ...
      const achievementsList: Achievement[] = [
        {
          ...
          earnedDate: eventsRegistered >= 1 ? registrations?.[0]?.registered_at : undefined,
        ...
        },
        {
          ...
          earnedDate: eventsRegistered >= 5 ? registrations?.[4]?.registered_at : undefined,
        ...
        },
        {
          ...
          earnedDate: eventsAttended >= 5 ? registrations?.filter(r => r.attended)[4]?.attended_at : undefined,
        ...
        },
        {
          ...
          earnedDate: attendanceRate >= 80 && eventsRegistered >= 3 ? new Date().toISOString() : undefined,
        ...
        },
        {
          ...
          earnedDate: eventsAttended >= 10 ? registrations?.filter(r => r.attended)[9]?.attended_at : undefined,
        ...
        },
        {
          ...
          earnedDate: membership?.status === "active" ? membership.start_date : undefined,
        ...
        },
        {
          ...
          earnedDate: membership?.tier === "gold" ? membership.start_date : undefined,
          progress: membership?.tier === "gold" ? 1 : membership?.tier === "silver" ? 0.66 : membership?.tier === "bronze" ? 0.33 : 0,
          maxProgress: 1,
        },
      ];
    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <div className="text-2xl font-bold text-blue-900">{earnedCount}</div>
              ...
              <div className="text-center p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-2xl font-bold text-green-900">{achievements.length - earnedCount}</div>
      ...
      {categories.map((category) => (
        <Card key={category}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              {category === "Events" && <Calendar className="h-5 w-5 text-purple-600" />}
              {category === "Participation" && <Users className="h-5 w-5 text-green-600" />}
              {category === "Membership" && <Award className="h-5 w-5 text-blue-600" />}
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge
                          ...
                          className={achievement.earned ? "bg-yellow-500 text-white" : ""}
                        >
